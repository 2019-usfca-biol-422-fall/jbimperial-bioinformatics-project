...
**Table 1:** Table of Qubit culture DNA concentration results. BART DNA concentrations signficantly vary, however concentrations are sufficient for PCR.
...
**Table 2:** Table of Qubit culture-free DNA concentration results measured in (ng/μl).
...
**Figure 2:** Image of culture-free PCRs from all 6 original DNA extractions. The ladder is located on the right, indicated that sequences are approximately 200bp.
...
**Figure 4:** Boxplot showing the number of morphotypes from the two different sites. There was a difference in the mean number of morphotypes, W = 1 and p = 0.16
...
**Table 3:** Sequence analysis after cleaning and trimming using Geneious. 
...
**Figure 5:** Maximum Likelihood Phylogeny of the three most successful samples with the root being *Thermus aquaticus*. M2 1:10 and B2 1:100 are more closely related than B1 1:100, with a bootstrap of 100. 

![](output/phylogenies/sanger_sequences_mrbayes.png)
**Figure 6:** A Bayesian Phylogeny with bootstrap 1 and Bayesian posterior probability of 0.07.
...
**Table 4:** A table of BLAST results from Sanger Sequence samples. The table indicates which strains are present in the bacterial colonies. 
